...
int jnla_get_addr4(struct nlattr *attr, char const *name, struct in_addr *out, struct jnl_state *state);
int jnla_get_prefix6(struct nlattr *attr, char const *name, struct ipv6_prefix *out, struct jnl_state *state);
int jnla_get_prefix6_optional(struct nlattr *attr, char const *name, struct config_prefix6 *out, struct jnl_state *state);
int jnla_get_prefix4(struct nlattr *attr, char const *name, struct ipv4_prefix *out, struct jnl_state *state);
int jnla_get_prefix4_optional(struct nlattr *attr, char const *name, struct config_prefix4 *out, struct jnl_state *state);
int jnla_get_taddr6(struct nlattr *attr, char const *name, struct ipv6_transport_addr *out, struct jnl_state *state);
int jnla_get_taddr4(struct nlattr *attr, char const *name, struct ipv4_transport_addr *out, struct jnl_state *state);
