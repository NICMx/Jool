...
static struct jstat_metadata const jstat_metadatas[] = {
	...
	DEFINE_STAT(JSTAT64_6791_ESRCH, TC "The rfc6791v4 prefix was needed, but it was unset and a suitable replacement could not be found. Cause is unknown."),
	...
	DEFINE_STAT(JSTAT46_6791_ESRCH, TC "The rfc6791v6 prefix was needed, but it was unset and a suitable replacement could not be found. Cause is unknown."),
