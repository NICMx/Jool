...
static struct argp_option options[] =
{
  ...
  {"bib",'b', 0, 0, "Estamos operando sobre las BIBs."},
  {"display",'d', 0, 0, "Muéstrame las tablas (-b, -s) o pool (-4, -6)."},
  {"static",669, 0, 0, "Solamente muestra lo que sea estático."},
  {"icmp", 'i', 0, 0, "Estamos operando sobre la tabla de ICMP."},
  {"tcp",'t', 0, 0, "Estamos operando sobre la tabla de TCP."},
  {"udp",'u', 0, 0, "Estamos operando sobre la tabla de UDP."},
  {"ipv4",440, "IP#port", 0, "Lo que sigue es una dirección, puerto, o dirección y puerto de IPv4."},
  {"ipv6",660, "IP#port", 0, "Lo que sigue es una dirección, puerto, o dirección y puerto de IPv6."},


  { 0, 0, 0, 0, "Session Options:", 20},
  {"session",'s', 0, 0, "Estamos operando sobre las tablas de sesión."},
  {"static",669, 0, 0, "Solamente muestra lo que sea estático."},
  {"display",'d', 0, 0, "Muéstrame las tablas (-b, -s) o pool (-4, -6)."},
  {"add",'a', 0, 0, "Estamos agregando un registro a una tabla (-b, -s) o direcciones a una pool (-4, -6)."},
  {"remove",'r', 0, 0, "Estamos removiendo un registro de una tabla (-b, -s) o direcciones de una pool (-4, -6)."},
  {"icmp", 'i', 0, 0, "Estamos operando sobre la tabla de ICMP."},
  {"tcp",'t', 0, 0, "Estamos operando sobre la tabla de TCP."},
  {"udp",'u', 0, 0, "Estamos operando sobre la tabla de UDP."},
  {"remote6",666, "IP#port", 0, "Lo que sigue es dirección, puerto, o dirección y puerto de la máquina remota en la red de IPv6."},
  {"local6",6666, "IP#port", 0, "Lo que sigue es dirección, puerto, o dirección y puerto local de la red de IPv6."},

  {"remote4",444, "IP#port", 0, "Lo que sigue es dirección, puerto, o dirección y puerto de la máquina remota en la red de IPv4."},
  {"local4",4444, "IP#port", 0, "Lo que sigue es dirección, puerto, o dirección y puerto local de la red de IPv4."},


  { 0, 0, 0, 0, "IPv6 Pool Options:", 10},
  {"pool6",'6', 0, 0, "Estamos operando sobre la pool de IPv6."},
  {"pref",600, "IP/mask", 0, "Prefijo IPv6."},
  {"display",'d', 0, 0, "Muéstrame las tablas (-b, -s) o pool (-4, -6)."},
  {"add",'a', 0, 0, "Estamos agregando un registro a una tabla (-b, -s) o direcciones a una pool (-4, -6)."},
  {"remove",'r', 0, 0, "Estamos removiendo un registro de una tabla (-b, -s) o direcciones de una pool (-4, -6)."},

  { 0, 0, 0, 0, "IPv4 Pool Options:", 11},
  {"pool4",'4', 0, 0, "Estamos operando sobre la pool de IPv4."},
  {"first",601, "IP", 0, "Primera IP del rango IPv4."},
  {"last",602, "IP", 0, "Ultima IP del rango IPv4."},
  {"display",'d', 0, 0, "Muéstrame las tablas (-b, -s) o pool (-4, -6)."},
  {"add",'a', 0, 0, "Estamos agregando un registro a una tabla (-b, -s) o direcciones a una pool (-4, -6)."},
  {"remove",'r', 0, 0, "Estamos removiendo un registro de una tabla (-b, -s) o direcciones de una pool (-4, -6)."},

  { 0, 0, 0, 0, "Hairpinning Options:", 12},
  {"hairpinning",'h', "on/off", 0, "Estamos operando sobre hairpinning."},

 { 0, 0, 0, 0, "Translator Options:", 13},
  {"trans",1200, 0, 0, "Estamos operando sobre las opciones del traductor."},
