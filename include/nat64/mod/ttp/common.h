...
struct translation_steps {
	 ...
	 */
	int (*l3_hdr_fn)(struct tuple *out_tuple, struct pkt_parts *in, struct pkt_parts *out);
	/**
	 ...
	 */
	int (*l3_payload_fn)(struct tuple *out_tuple, struct pkt_parts *in, struct pkt_parts *out);
