...
enum argp_flags {
	...
	ARGP_ATOMIC_FRAGMENTS = ATOMIC_FRAGMENTS,
	ARGP_DF = DF_ALWAYS_ON,
	ARGP_BUILD_FH = BUILD_IPV6_FH,
	ARGP_BUILD_ID = BUILD_IPV4_ID,
	ARGP_LOWER_MTU_FAIL = LOWER_MTU_FAIL,
	...
	ARGP_SYNCH_ENABLE = SYNCH_ENABLE,
	ARGP_SYNCH_DISABLE = SYNCH_DISABLE,
	ARGP_SYNCH_FLUSH_ASAP = SYNCH_FLUSH_ASAP,
	ARGP_SYNCH_FLUSH_DEADLINE = SYNCH_FLUSH_DEADLINE,
	ARGP_SYNCH_CAPACITY = SYNCH_CAPACITY,
	ARGP_SYNCH_MAX_PAYLOAD = SYNCH_MAX_PAYLOAD,
