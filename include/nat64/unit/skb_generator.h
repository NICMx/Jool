...
//int init_udp_hdr(void *l4_hdr, int l3_hdr_type, u16 datagram_len, void *arg);
//int init_tcp_hdr(void *l4_hdr, int l3_hdr_type, u16 datagram_len, void *arg);
//int init_icmp4_hdr(void *l4_hdr, int l3_hdr_type, u16 datagram_len, void *arg);
//int init_icmp6_hdr(void *l4_hdr, int l3_hdr_type, u16 datagram_len, void *arg);
//int init_payload_normal(void *l4_hdr);
