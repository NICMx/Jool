...
2. [Milestone 4.0.0]({{ site.repository-url }}/issues?q=milestone%3A4.0.0) will be a [framework revision]({{ site.repository-url }}/issues/140). Jool will probably be able to become a device driver, and this might make it more intuitive to configure.
3. [Milestone 4.1.0]({{ site.repository-url }}/issues?q=milestone%3A4.1.0) will add several new features.
