...
- Expected packets (src: `2001:db8:1c0:2:1:0:0:0`, dst: `2001:db8:1c0:2:21:0:0:0`, no hop limit - 1):
...
- Expected packets:
	1. IPv6 packet (no fragment header) sized 1280
		1. IPv6: 40 (TTL-1, swapped addresses)
		2. TCP: 20
		3. Payload: 1220
- Validation: `test-1` must yield `expected-1`.
...
- Environment: IPv6 MTU = 1280, IPv4 MTU >= 1261
- Test packets:
	1. IPv4/TCP fragment sized 1261
...
- Expected packets:
	...
	2. IPv6 fragment sized 57
		1. IPv6: 40 (TTL-1, swap addresses)
		2. Fragment: 8 (Nexthdr TCP, Fragment offset 1232, ID 4321)
		3. Payload: 9 (Offset: 188)
- Validation: `test-1` must yield `expected-1` and `expected-2`, `test-2` must yield `expected-1` and `expected-2`.
...
I just noticed: According to this test, n6 is telling n4 than n6 cannot be reached. It's stupid, but doesn't break any xlat rules.
