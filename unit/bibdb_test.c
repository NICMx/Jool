...
static bool test_flow(void)
{
	...
	bibentry_put(bibs4[3][20]);
	bibs6[2][18] = bibs4[3][20] = NULL;
	success &= test_db();

	bibentry_put(bibs4[1][21]);
	bibs6[0][10] = bibs4[1][21] = NULL;
	success &= test_db();

	bibentry_put(bibs4[2][12]);
	bibs6[0][20] = bibs4[2][12] = NULL;
	success &= test_db();

	bibentry_put(bibs4[3][10]);
	bibs6[3][10] = bibs4[3][10] = NULL;
	success &= test_db();

	bibentry_put(bibs4[2][22]);
	bibs6[3][20] = bibs4[2][22] = NULL;
	success &= test_db();

	bibentry_put(bibs4[0][20]);
	bibs6[1][19] = bibs4[0][20] = NULL;
	success &= test_db();

	bibentry_put(bibs4[0][10]);
	bibs6[2][8] = bibs4[0][10] = NULL;
	success &= test_db();

	bibentry_put(bibs4[1][11]);
	bibs6[1][9] = bibs4[1][11] = NULL;
	success &= test_db();
