...
Currently, 4.1.15 is the most mature version of Jool.

| Release Date | Version | .tar.gz | .tar.gz Signature | Git commit | .deb |
|--------------|---------|---------|-------------------|------------|------|
| 2026-01-26   | **4.1.15** | [Download]({{ page.url-dl }}/v4.1.15/jool-4.1.15.tar.gz) | [Signature]({{ page.url-dl }}/v4.1.15/jool-4.1.15.tar.gz.asc) | <a href="{{ site.repository-url }}/tree/v4.1.15" target="_blank">Link</a> | [Kernel modules]({{ page.url-dl }}/v4.1.15/jool-dkms_4.1.15-1_all.deb)<br />[Userspace tools]({{ page.url-dl }}/v4.1.15/jool-tools_4.1.15-1_amd64.deb) (amd64 only) |
