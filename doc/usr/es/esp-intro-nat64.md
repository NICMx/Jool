...
Para conocer el resto de los escenarios posibles consulta el [RFC 6144, cap. 2] (https://tools.ietf.org/html/rfc6144#section-2). Aquí también se incluyen los de ** SIIT **
